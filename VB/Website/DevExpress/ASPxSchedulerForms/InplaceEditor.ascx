...
<%@ Control Language="vb" AutoEventWireup="true" CodeFile="InplaceEditor.ascx.vb" Inherits="InplaceEditor" %>
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v8.1" Namespace="DevExpress.Web.ASPxScheduler" TagPrefix="dxwschs" %>
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v8.1" Namespace="DevExpress.Web.ASPxScheduler.Controls"
	TagPrefix="cc1" %>
	...
	<tr>
		...
		<div>
			<cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnSave" Width="19px" Height="19px" ToolTip="Save" 
				...
				OnClientClick='<%#(CType(Container, AppointmentInplaceEditorTemplateContainer)).SaveHandler%>' Image-IsResourcePng="True">
		...
		<div style="padding-top:1px;">
			<cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnCancel" Width="19px" Height="19px" ToolTip="Cancel" 
				...
				OnClientClick='<%#(CType(Container, AppointmentInplaceEditorTemplateContainer)).CancelHandler%>'
		...
		<div style="padding-top:6px;">
			<cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnEditForm" Width="19px" Height="19px" ToolTip="Open Edit Form..." 
				...
				OnClientClick='<%#(CType(Container, AppointmentInplaceEditorTemplateContainer)).EditFormHandler%>'
				CausesValidation="False" Image-IsResourcePng="True">
			 <Image Height="19px" Width="19px" />
			</cc1:NoBorderButton>
		</div>

...
<%@ Control Language="vb" AutoEventWireup="true" CodeFile="GotoDateForm.ascx.vb" Inherits="GotoDateForm" %>
	...
	<tr>
		<td align="center" colspan="2" style="width:100%">
			<table>
				<tr>
					<td>
						<dxe:ASPxButton ID="btnOk" ClientInstanceName="_dx" runat="server" Text="OK" UseSubmitBehavior="false" AutoPostBack="false" EnableViewState="false" Width="91px" OnClientClick='<%#(CType(Container, DevExpress.Web.ASPxScheduler.GotoDateFormTemplateContainer)).ApplyHandler%>' />
					</td>
					<td>
						<dxe:ASPxButton ID="btnCancel" ClientInstanceName="_dx" runat="server" Text="Cancel" UseSubmitBehavior="false" AutoPostBack="false" EnableViewState="false" 
							Width="91px" CausesValidation="False" OnClientClick='<%#(CType(Container, DevExpress.Web.ASPxScheduler.GotoDateFormTemplateContainer)).CancelHandler%>' />
					</td>
				</tr>
			</table>
		</td>

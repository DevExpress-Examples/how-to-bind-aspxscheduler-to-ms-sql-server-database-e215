...
{************************************************************************************}
--%>
<%@ Control Language="vb" AutoEventWireup="true" CodeFile="RecurrentAppointmentDeleteForm.ascx.vb" Inherits="RecurrentAppointmentDeleteForm" %>
	...
	<tr>
		<td align="center" style="width:100%" colspan="2">
			<table>
				<tr>
					<td>
						<dxe:ASPxButton ID="btnOk" ClientInstanceName="_dx" runat="server" Text="OK" UseSubmitBehavior="false" AutoPostBack="false" EnableViewState="false" Width="91px" OnClientClick='<%#(CType(Container, DevExpress.Web.ASPxScheduler.RecurrentAppointmentDeleteFormTemplateContainer)).ApplyHandler%>' />
					</td>
					<td>
						<dxe:ASPxButton ID="btnCancel" ClientInstanceName="_dx" runat="server" Text="Cancel" UseSubmitBehavior="false" AutoPostBack="false" EnableViewState="false" 
							Width="91px" CausesValidation="False" OnClientClick='<%#(CType(Container, DevExpress.Web.ASPxScheduler.RecurrentAppointmentDeleteFormTemplateContainer)).CancelHandler%>' />
					</td>
				</tr>
			</table>
		</td>

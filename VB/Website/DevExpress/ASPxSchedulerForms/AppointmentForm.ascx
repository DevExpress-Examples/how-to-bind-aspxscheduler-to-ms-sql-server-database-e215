...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v8.1" Namespace="DevExpress.Web.ASPxScheduler.Controls" TagPrefix="dxsc" %>
				...
				<tr>
					...
					<td class="dxscControlCell">
						<dxe:ASPxDateEdit id="edtEndDate" runat="server" ClientInstanceName="_dx" Date='<%#(CType(Container, AppointmentFormTemplateContainer)).End%>'
							EditFormat="DateTime" Width="100%" PopupCalendarOwnerID="edtStartDate">
						</dxe:ASPxDateEdit>
					</td>
				</tr>
			</table>
